...
intrinsic CurveDataForPCompleteDim6(p::RngIntElt, r::RngIntElt : fam := 1) -> SeqEnum
    ...
    if fam eq 1 then
        time TupleSet := Set([F![a1,a2,a3,a4,a5,a6,0,a6,0,1] : a1,a2,a3,a4,a5,a6 in Fp | a6 ne 0]);
        TupleSet := RemoveDuplicates(TupleSet, 2);
    elif fam eq 2 then
        time TupleSet := Set([F![a1,a2,a3,a4,a5,a6,a6,0,0,1] : a1,a2,a3,a4,a5,a6 in Fp | a6 ne 0]);
    else
        "fam parameter should be 1 or 2";
    end if;
